...
class LanguageService {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      // Yearly report translations
      'yearly_report': 'Yearly Report',
      'yearly_report_description':
          'Generate a comprehensive report for the entire year',
      'yearly_report_title': '{year} Yearly Report 📊',
      'yearly_income_summary': 'Yearly Income Summary',
      'yearly_expense_summary': 'Yearly Expense Summary',
      'monthly_breakdown': 'Monthly Breakdown',
      'total_yearly_income': 'Total Yearly Income',
      'total_yearly_expenses': 'Total Yearly Expenses',
    ...
    'hi': {
      ...
      'premium_feature_charts': 'उन्नत चार्ट और भिज्युयालाइज़ेशन',
      ...
      'yearly_report_description': 'पूरे साल की व्यापक रिपोर्ट तैयार करें',
      'yearly_report_title': '{year} वार्षिक रिपोर्ट 📊',
      'yearly_income_summary': 'वार्षिक आय सारांश',
      'yearly_expense_summary': 'वार्षिक व्यय सारांश',
      'monthly_breakdown': 'मासिक विवरण',
      'total_yearly_income': 'कुल वार्षिक आय',
      'total_yearly_expenses': 'कुल वार्षिक व्यय',
    ...
    'ur': {
      ...
      'savings_emoji': 'बचत 💵',
      'pending_payment_request':
          '*अनुग्रह करें और {month} महीने के लिए अदा करें:*',
      'share_report': 'रिपोरٹ शेयर करें',
      'select_what_to_share': 'आप क्या शेयर करना चाहते हैं उसे चुनें',
      'full_report': 'पूरी रिपोर्ट',
      ...
      'yearly_report_description': 'پورے سال کی جامع رپورٹ تیار کریں',
      'yearly_report_title': '{year} سالانہ رپورٹ 📊',
      'yearly_income_summary': 'سالانہ آمدنی کا خلاصہ',
      'yearly_expense_summary': 'سالانہ اخراجات کا خلاصہ',
      'monthly_breakdown': 'ماہانہ تفصیل',
      'total_yearly_income': 'کل سالانہ آمدنی',
      'total_yearly_expenses': 'کل سالانہ اخراجات',
    ...
    'bn': {
      ...
      'yearly_report_description':
          'পুরো বছরের জন্য একটি বিস্তৃত রিপোর্ট তৈরি করুন',
      'yearly_report_title': '{year} বার্ষিক রিপোর্ট 📊',
      'yearly_income_summary': 'বার্ষিক আয়ের সারাংশ',
      'yearly_expense_summary': 'বার্ষিক ব্যয়ের সারাংশ',
      'monthly_breakdown': 'মাসিক বিভাজন',
      'total_yearly_income': 'মোট বার্ষিক আয়',
      'total_yearly_expenses': 'মোট বার্ষিক ব্যয়',
      'net_savings': 'নেট সঞ্চয়',
